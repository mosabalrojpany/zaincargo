...
<div class="container my-5">
    ...
    <div class="d-flex justify-content-between">
        <h4 class="font-weight-bold">أنواع الأصناف {{ count($types) }}</h4>
...
<div class="modal fade" id="Modal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class='formSendAjaxRequest was-validated' refresh-seconds='2' action="{{ url('/cp/item-types') }}" method="post">
...
@section('extra-js')
    <script> 
            var addAction = "{{ url('/cp/item-types') }}";
            var editAction = "{{ url('/cp/item-types/edit') }}";

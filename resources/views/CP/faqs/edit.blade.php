...
@section('content')
    ...
    <div class="card border-0 shadow">
        ...
        <div class="card-body">
            ...
            <form id="form-post" class="text-right was-validated formSendAjaxRequest" redirect-to="{{ url('cp/faqs') }}" action="{{ url('cp/faqs/edit') }}" focus-on=".breadcrumb" refresh-seconds="1" method="POST">
                ...
                <div class="form-group row mb-3 text-right">
                    ...
                    <div class="col-sm">
                        <input type="text" class="form-control" value="{{ $faq->question }}" name="question" placeholder="السؤال" pattern="\s*([\S]\s*){10,150}" required>
                ...
                <div class="row justify-content-between mt-3">
                    <div class="col-md-4">
                        <div class="form-group row">
                            ...
                            <div class="col-sm">
                                <select name="state" class="form-control setValue" value="{{ $faq->active }}" required>

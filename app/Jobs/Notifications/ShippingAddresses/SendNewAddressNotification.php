...
use App\Notifications\ShippingAddresses\NewAddress;
...
class SendNewAddressNotification implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Notification::send($customers, new NewAddress($this->shippingAddress));
    }

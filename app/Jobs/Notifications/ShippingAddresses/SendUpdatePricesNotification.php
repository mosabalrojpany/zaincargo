...
use App\Notifications\ShippingAddresses\UpdatePrices;
...
class SendUpdatePricesNotification implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Notification::send($customers, new UpdatePrices($this->shippingAddress));
    }
}
